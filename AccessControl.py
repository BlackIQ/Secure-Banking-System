...
class AccessControl:
    ...
    def has_write_access(self, username):
        return 1
    ...
    def has_read_access(self, username, account_no):
        ...
        print (response, user_integrity_label,user_confidentiality_label,acc_integrity_label,acc_confidentiality_label, type(acc_confidentiality_label))
